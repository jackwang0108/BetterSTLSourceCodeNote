...
// 一元仿函数， 可配接的一元仿函数都应该继承此类
template<class _Arg, class _Result>
struct unary_function {
	// 定义了相应类型供配接器萃取
	// typename T::argument_type value;
	typedef _Arg argument_type;
	typedef _Result result_type;
};

// 二元仿函数， 可配接的二元仿函数都应该继承此类
...
public:
	...
	bool operator()(const typename _Predicate::argument_type &__x) const {
		return !_M_pred(__x);// 将谓词结果加上否定运算
	}
};
...
public:
	...
	bool operator()(const typename _Predicate::first_argument_type &__x,
		...
		return !_M_pred(__x, __y);// 对谓词结果加上否定运算
	}
};
...
public:
	binary_compose(const _Operation1 &__x, const _Operation2 &__y,
	    ...
	    : _M_fn1(__x), _M_fn2(__y), _M_fn3(__z) {}// 记录表达式
	typename _Operation1::result_type
	operator()(const typename _Operation2::argument_type &__x) const {
...
protected:
	_Result (*_M_ptr)(_Arg1, _Arg2);// 内部成员，函数指针
public:
...
// 以下可以用函数重载
template<class _Ret, class _Tp, class _Arg>
inline mem_fun1_t<_Ret, _Tp, _Arg> mem_fun(_Ret (_Tp::*__f)(_Arg)) { return mem_fun1_t<_Ret, _Tp, _Arg>(__f); }

template<class _Ret, class _Tp, class _Arg>
inline const_mem_fun1_t<_Ret, _Tp, _Arg> mem_fun(_Ret (_Tp::*__f)(_Arg) const) { return const_mem_fun1_t<_Ret, _Tp, _Arg>(__f); }

template<class _Ret, class _Tp, class _Arg>
inline mem_fun1_ref_t<_Ret, _Tp, _Arg> mem_fun_ref(_Ret (_Tp::*__f)(_Arg)) { return mem_fun1_ref_t<_Ret, _Tp, _Arg>(__f); }
...
template<class _Ret, class _Tp, class _Arg>
inline mem_fun1_t<_Ret, _Tp, _Arg> mem_fun1(_Ret (_Tp::*__f)(_Arg)) { return mem_fun1_t<_Ret, _Tp, _Arg>(__f); }

template<class _Ret, class _Tp, class _Arg>
inline const_mem_fun1_t<_Ret, _Tp, _Arg> mem_fun1(_Ret (_Tp::*__f)(_Arg) const) { return const_mem_fun1_t<_Ret, _Tp, _Arg>(__f); }

template<class _Ret, class _Tp, class _Arg>
inline mem_fun1_ref_t<_Ret, _Tp, _Arg> mem_fun1_ref(_Ret (_Tp::*__f)(_Arg)) { return mem_fun1_ref_t<_Ret, _Tp, _Arg>(__f); }
