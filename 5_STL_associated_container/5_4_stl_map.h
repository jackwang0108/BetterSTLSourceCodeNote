...
public:
	...
	typedef _Compare key_compare;            //比较函数
...
#	ifdef __STL_MEMBER_TEMPLATES
	...
	map(_InputIterator __first, _InputIterator __last)
	    : _M_t(_Compare(), allocator_type()) { _M_t.insert_unique(__first, __last); }
