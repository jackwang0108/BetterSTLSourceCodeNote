...
template<class _CharT, class _Alloc>
inline _Rope_const_iterator<_CharT, _Alloc>::_Rope_const_iterator(
...
void _Rope_RopeRep<_CharT, _Alloc>::_M_free_tree() {
	switch (_M_tag) {
		case _S_leaf: {
			_Rope_RopeLeaf<_CharT, _Alloc> *__l = (_Rope_RopeLeaf<_CharT, _Alloc> *) this;
			__l->_Rope_RopeLeaf<_CharT, _Alloc>::~_Rope_RopeLeaf();
			_L_deallocate(__l, 1);
			break;
		}
		case _S_concat: {
			_Rope_RopeConcatenation<_CharT, _Alloc> *__c = (_Rope_RopeConcatenation<_CharT, _Alloc> *) this;
		...
		case _S_function: {
			_Rope_RopeFunction<_CharT, _Alloc> *__f = (_Rope_RopeFunction<_CharT, _Alloc> *) this;
...
template<class _CharT, class _Alloc>
#	ifdef __STL_USE_STD_ALLOCATORS
inline void _Rope_RopeRep<_CharT, _Alloc>::_S_free_string(const _CharT *, size_t, allocator_type)
#	else
inline void _Rope_RopeRep<_CharT, _Alloc>::_S_free_string(const _CharT *, size_t)
#	endif
{
}
...
rope<_CharT, _Alloc>::_S_leaf_concat_char_iter(_RopeLeaf *__r, const _CharT *__iter, size_t __len) {
	...
	if (__depth > 20 && (__result->_M_size < 1000 ||
		...
		__STL_TRY {
			...
			if (__result != __balanced) {
				__stl_assert(1 == __result->_M_ref_count && 1 == __balanced->_M_ref_count);
			}
#endif
...
template<class _CharT, class _Alloc>
rope<_CharT, _Alloc>::_RopeRep *rope<_CharT, _Alloc>::_S_concat_char_iter(_RopeRep *__r, const _CharT *__s, size_t __slen) {
	_RopeRep *__result;
	if (0 == __slen) {
		_S_ref(__r);
		return __r;
	...
	if (_RopeRep::_S_concat == __r->_M_tag && _RopeRep::_S_leaf == ((_RopeConcatenation *) __r)->_M_right->_M_tag) {
		_RopeLeaf *__right =
...
rope<_CharT, _Alloc>::_S_destr_concat_char_iter(
	...
	if (_RopeRep::_S_concat == __r->_M_tag) {
		...
		if (_RopeRep::_S_leaf == __right->_M_tag && __right->_M_size + __slen <= _S_copy_max) {
...
rope<_CharT, _Alloc>::_S_concat(_RopeRep *__left, _RopeRep *__right) {
	...
	if (_RopeRep::_S_leaf == __right->_M_tag) {
		...
		} else if (_RopeRep::_S_concat == __left->_M_tag && _RopeRep::_S_leaf ==
...
#ifdef __STL_USE_NEW_IOSTREAMS
template<class _CharT, class _Traits>
bool _Rope_insert_char_consumer<_CharT, _Traits>::operator()(const _CharT *__leaf, size_t __n) {
	size_t __i;
...
#else
template<class _CharT>
bool _Rope_insert_char_consumer<_CharT>::operator()(const _CharT *__leaf, size_t __n) {
	size_t __i;
	//  We assume that formatting is set up correctly for each element.
...
__STL_TEMPLATE_NULL
inline bool _Rope_insert_char_consumer<char>::operator()(const char *__leaf, size_t __n) {
	size_t __i;
	for (__i = 0; __i < __n; __i++) _M_o.put(__leaf[__i]);
	return true;
}
...
template<class _CharT>
inline bool _Rope_is_simple(_CharT *) { return false; }
...
template<class _CharT, class _Alloc>
const unsigned long
    rope<_CharT, _Alloc>::_S_min_len[_Rope_RopeRep<_CharT, _Alloc>::_S_max_rope_depth + 1] = {
...
template<class _CharT, class _Alloc>
void rope<_CharT, _Alloc>::_S_add_to_forest(_RopeRep *__r, _RopeRep **__forest) {
...
template<class _CharT, class _Alloc>
void rope<_CharT, _Alloc>::_S_add_leaf_to_forest(_RopeRep *__r, _RopeRep **__forest) {
...
// flat strings.
template<class _CharT, class _Alloc>
int rope<_CharT, _Alloc>::_S_compare(const _RopeRep *__left,
...
_Rope_rotate(_Rope_iterator __first,
	...
	__stl_assert(__first.container() == __middle.container() && __middle.container() == __last.container());
