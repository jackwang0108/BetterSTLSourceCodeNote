...
struct _Eq_traits
	...
	bool operator()(const typename _Traits::char_type &__x,
	                const typename _Traits::char_type &__y) const { return _Traits::eq(__x, __y); }
};
...
struct _Eq_int_traits
    : public binary_function<typename _Traits::char_type,
                             ...
                             bool> {
	bool operator()(const typename _Traits::char_type &__x,
	                const typename _Traits::int_type &__y) const { return _Traits::eq_int_type(_Traits::to_int_type(__x), __y); }
};
...
struct _Lt_traits
    : public binary_function<typename _Traits::char_type,
                             ...
                             bool> {
	bool operator()(const typename _Traits::char_type &__x,
	                const typename _Traits::char_type &__y) const { return _Traits::lt(__x, __y); }
};
