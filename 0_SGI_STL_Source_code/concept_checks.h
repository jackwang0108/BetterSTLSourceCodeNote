...
struct _TrivialIterator_concept_specification {
	...
	_TrivialIterator_requirement_violation(_TrivialIterator __i) {
		typedef typename __value_type_type_definition_requirement_violation<_TrivialIterator>::
		    value_type __T;
...
struct _Mutable_BidirectionalIterator_concept_specification {
	...
	_Mutable_BidirectionalIterator_requirement_violation(
		...
		typedef typename __value_type_type_definition_requirement_violation<
...
struct _RandomAccessIterator_concept_specification {
	...
	_RandomAccessIterator_requirement_violation(_RandAccIter __i) {
		...
		typedef typename __value_type_type_definition_requirement_violation<_RandAccIter>::value_type
		    value_type;
		typedef typename __difference_type_type_definition_requirement_violation<_RandAccIter>::difference_type
		    _Dist;
